...
type BatchExecutionResult struct {
	...
	// Message If the Batch Execution Request failed, this message might have more info about the error
...
// BatchResultRequest Get the result of an Batch Execution Request, identified by the request ID
type BatchResultRequest struct {
	// Id ID of the Batch Execution Request
	Id string `json:"id"`
}
...
type ExecutionRequest struct {
	...
	// Deprecated: Use the `arguments` field.
...
// BatchExecutionResultJSONRequestBody defines body for BatchExecutionResult for application/json ContentType.
type BatchExecutionResultJSONRequestBody = BatchResultRequest
