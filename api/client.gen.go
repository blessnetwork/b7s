...
type ClientInterface interface {
	...
	// BatchExecutionResultWithBody request with any body
	BatchExecutionResultWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	BatchExecutionResult(ctx context.Context, body BatchExecutionResultJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) BatchExecutionResultWithBody(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBatchExecutionResultRequestWithBody(c.Server, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) BatchExecutionResult(ctx context.Context, body BatchExecutionResultJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewBatchExecutionResultRequest(c.Server, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func NewExecuteFunctionBatchRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/api/v1/functions/execute/batch")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewBatchExecutionResultRequest calls the generic BatchExecutionResult builder with application/json body
func NewBatchExecutionResultRequest(server string, body BatchExecutionResultJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewBatchExecutionResultRequestWithBody(server, "application/json", bodyReader)
}

// NewBatchExecutionResultRequestWithBody generates requests for BatchExecutionResult with any type of body
func NewBatchExecutionResultRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/v1/functions/execute/batch/result")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// BatchExecutionResultWithBodyWithResponse request with any body
	BatchExecutionResultWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BatchExecutionResultResponse, error)

	BatchExecutionResultWithResponse(ctx context.Context, body BatchExecutionResultJSONRequestBody, reqEditors ...RequestEditorFn) (*BatchExecutionResultResponse, error)
...
type ExecuteFunctionBatchResponse struct {
	Body         []byte
	HTTPResponse *http.Response
...
// Status returns HTTPResponse.Status
func (r ExecuteFunctionBatchResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r ExecuteFunctionBatchResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// Status returns HTTPResponse.Status
func (r BatchExecutionResultResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r BatchExecutionResultResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// BatchExecutionResultWithBodyWithResponse request with arbitrary body returning *BatchExecutionResultResponse
func (c *ClientWithResponses) BatchExecutionResultWithBodyWithResponse(ctx context.Context, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*BatchExecutionResultResponse, error) {
	rsp, err := c.BatchExecutionResultWithBody(ctx, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBatchExecutionResultResponse(rsp)
}

func (c *ClientWithResponses) BatchExecutionResultWithResponse(ctx context.Context, body BatchExecutionResultJSONRequestBody, reqEditors ...RequestEditorFn) (*BatchExecutionResultResponse, error) {
	rsp, err := c.BatchExecutionResult(ctx, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseBatchExecutionResultResponse(rsp)
...
// ParseExecuteFunctionBatchResponse parses an HTTP response from a ExecuteFunctionBatchWithResponse call
func ParseExecuteFunctionBatchResponse(rsp *http.Response) (*ExecuteFunctionBatchResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &ExecuteFunctionBatchResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParseBatchExecutionResultResponse parses an HTTP response from a BatchExecutionResultWithResponse call
func ParseBatchExecutionResultResponse(rsp *http.Response) (*BatchExecutionResultResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &BatchExecutionResultResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
